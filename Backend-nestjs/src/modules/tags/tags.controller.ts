...
export class TagsController {
  ...
  @Post()
  @RequirePermissions(PERMISSIONS.TAG_CREATE)
  ...
  async findAllPaginate(
    ...
    return this.tagsService.findAllPaginate(
      page,
      limit,
      sortBy,
      sortOrder,
  ...
  @Patch(':id')
  @RequirePermissions(PERMISSIONS.TAG_UPDATE)
  ...
  @Delete(':id')
  @RequirePermissions(PERMISSIONS.TAG_DELETE)
