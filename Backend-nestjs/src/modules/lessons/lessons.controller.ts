...
export class LessonsController {
  ...
  @Post()
  @RequirePermissions(PERMISSIONS.LESSON_CREATE)
  ...
  @Get()
  @RequirePermissions(PERMISSIONS.LESSON_READ)
  findAll() {
  ...
  @Patch(':id')
  @RequirePermissions(PERMISSIONS.LESSON_UPDATE)
  ...
  @Delete(':id')
  @RequirePermissions(PERMISSIONS.LESSON_DELETE)
