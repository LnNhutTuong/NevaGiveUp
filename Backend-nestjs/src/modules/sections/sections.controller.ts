...
export class SectionsController {
  ...
  @Post()
  @RequirePermissions(PERMISSIONS.SECTION_CREATE)
  ...
  @Get()
  @RequirePermissions(PERMISSIONS.SECTION_READ)
  ...
  @Patch(':id')
  @RequirePermissions(PERMISSIONS.SECTION_UPDATE)
  ...
  @Delete(':id')
  @RequirePermissions(PERMISSIONS.SECTION_DELETE)
